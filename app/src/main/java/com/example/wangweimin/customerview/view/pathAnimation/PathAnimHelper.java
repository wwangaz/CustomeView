...
public class PathAnimHelper {
     ...
     * @param totalDuration 动画一共的时间
     * @param isInfinite     是否无限循环
     */
    protected void startAnim(View view, Path sourcePath, Path animPath, long totalDuration, boolean isInfinite) {
        if (view == null || sourcePath == null || animPath == null) {
            return;
        }
        ...
        pathMeasure.setPath(sourcePath, false);
        loopAnim(view, sourcePath, animPath, totalDuration, pathMeasure, totalDuration / count, isInfinite);
    }

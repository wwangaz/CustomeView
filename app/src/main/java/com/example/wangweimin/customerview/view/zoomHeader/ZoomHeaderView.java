...
public class ZoomHeaderView extends LinearLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        viewPager = (ZoomHeaderViewPager) getChildAt(1);
        mFirstY = getY();
    ...
    private void doPagerDown(float moveY, float currentY) {
        ...
        View v = viewPager.getChildAt(pos);
        v.setTranslationY((currentY + moveY) / 4);
        mCloseText.setAlpha(v.getY() / 76);
    }
    ...
    public void restore(float y) {
        ...
        ((CtrlLinearLayoutManager) recyclerView.getLayoutManager()).setScrollEnabled(false);
    ...
    private void expand(float y) {
        ...
        ((CtrlLinearLayoutManager) recyclerView.getLayoutManager()).setScrollEnabled(true);
